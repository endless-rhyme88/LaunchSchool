...
#2nd refactoring: 
#removing parantheses from methods
#omitting 'Kernel' from methods
#note: The Kernel module is included by class Object, so its methods are available in every Ruby object.